      ...
      <div className="w-full max-w-md rounded-xl bg-white shadow-[0_10px_35px_rgba(0,0,0,0.1)] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-5">
          ...
          <div className="mb-6 flex items-center gap-2">
            ...
            />
            <label htmlFor="activa" className="text-[12px] font-medium text-[#182c4c] cursor-pointer">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 rounded-md text-[13px] font-bold text-white bg-[#0b9349] hover:bg-[#087d3e] transition-colors disabled:opacity-70 flex items-center justify-center min-w-[120px]"
            >
              {loading ? 'Guardando...' : 'Guardar Elección'}
            </button>
          </div>
        </form>
      </div>
